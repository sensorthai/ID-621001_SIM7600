...
ModbusClientRTU::ModbusClientRTU(HardwareSerial &serial, int8_t rtsPin, uint16_t queueLimit) : ModbusClient(),
                                                                                               MR_serial(serial),
...
ModbusClientRTU::ModbusClientRTU(HardwareSerial &serial, RTScallback rts, uint16_t queueLimit) : ModbusClient(),
                                                                                                 MR_serial(serial),
                                                                                                 MR_lastMicros(micros()),
                                                                                                 MR_interval(2000),
                                                                                                 MTRSrts(rts),
...
void ModbusClientRTU::handleConnection(ModbusClientRTU *instance)
{
  ...
  while (instance->MR_serial.available())
    instance->MR_serial.read();
  delay(100);
